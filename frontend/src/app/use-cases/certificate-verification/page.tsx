                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="pt-4 border-t border-gray-200 dark:border-gray-600">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <a
                                                href="https://testnet.explorer.perawallet.app/asset/746528771"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="mt-1 items-center bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center space-x-2"
                                            >
